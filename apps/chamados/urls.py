...
from .views import ChamadoListView, ChamadoCreateView, ChamadoDetailView, ChamadoUpdateView, ChamadoDeleteView, ChamadoMudarStatusView, ItemChamadoCreateView, ItemChamadoDeleteView, ItemChamadoUpdateView, ChamadosAtribuidosView 
